...
def chooseCave(): 
    cave = ''
	#while cave != '1' and cave != '2': #indention over too far
    while cave != '1' and cave != '2':
		#print('Which cave will you go into? (1 or 2)') indention over too far
        print('Which cave will you go into? (1 or 2)')
		#cave = input() indention over too far
        cave = input()
	#return caves supposed to cave not caves
        return cave
...
while playAgain == 'yes' or playAgain== 'y':
    ...
    displayIntro()
	#caveNumber = choosecave()#choosecave not camelCased the c for cave needs capital #indentation
	
    caveNumber = chooseCave()
	#checkCave(caveNumber) indentation
